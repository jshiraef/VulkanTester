...
public:
	...
	void loadMeshes()
	{
		loadMesh("./../data/models/chinesedragon.X", &meshes.object, vertexLayout, 0.05f);
	}
	...
	void preparePipelines()
	{
		...
		VkResult err = vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCreateInfo, nullptr, &pipelines.sem);
		assert(!err);
	}
